...
public class Komputer { // >>>>>>>> NO 1 Adalah ( Class Declaration )
    ...
    public static void main(String[] args) {
        Komputer mykom = new Komputer(); ///////////////////////////// NO 6 (Main Method)(Membuat objek mykom dari kelas
                                         ///////////////////////////// Komputer)
        mykom.setDataKomputer("Laptop", "MSI"); ////////// NO 7 (Main Method) (Mengatur nilai jenis dan merk komputer
                                                ////////// menggunakan method setDataKomputer)

        System.out.println(mykom.getJenis()); //////////////// NO 8 (Main Method)(Mencetak jenis komputer menggunakan
                                              //////////////// method getJenis dan method getMerk)
